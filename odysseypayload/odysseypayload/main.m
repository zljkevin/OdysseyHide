...
void* threadproc(void* p)
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSString* showmsg = @"我在越狱啊2";
        
//        char accname[128]={0};
//
//        NSString* sinfpath = [[NSBundle mainBundle] pathForResource:@"SC_Info/Amazon" ofType:@"sinf"];
//
//
//
//        if(sinfpath) {
//            FILE* fp = fopen([sinfpath UTF8String], "r");
//            showmsg = [[NSString alloc] initWithFormat:@"test  %s, %x, %s", [sinfpath UTF8String], fp, strerror(errno)];
//
//            if(fp) {
//
//
...
//        }
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"我在干嘛?" message:showmsg preferredStyle:UIAlertControllerStyleAlert];
...
__attribute__ ( (constructor ) ) static void initfunc()
{
    ...
    if([pname isEqual:@"debugserver"]) return; //for xcode
...
//    }
    ...
    NSLog(@"payload=%x %s", dlopen("/private/var/containers/Bundle/odyssey/payload", RTLD_NOW), dlerror());
