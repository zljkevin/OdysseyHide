...
STRINGS.WIFI_TRANS_TITLE = 'WiFi 传脚本';
STRINGS.FILES_ON_DEVICE = '您设备上的文件列表';
STRINGS.FILENAME = '文件名';
STRINGS.FILE_SIZE = '大小';
STRINGS.FILE_OPER = '操作';
STRINGS.CONFIRM_DELETE_BOOK = '是否删除脚本？';
STRINGS.DOWNLOAD_FILE = '下载';
STRINGS.DELETE_FILE = '删除';
STRINGS.LOCK_FILE = '查看';
STRINGS.EDETEOR_FILE = '编辑';
STRINGS.USE_ONE_BROWSER = '无法上传文件，请勿使用多个浏览器窗口同时上传。';
STRINGS.UPLOAD_FAILED = '上传失败，请重新打开WiFi传脚本服务并刷新此页重新上传。';
STRINGS.UNSUPPORTED_FILE_TYPE = '请选择LUA、LUAC或TSP文件。';
...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到触动精灵的文件';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接WiFi传脚本服务器，请重新打开WiFi传脚本服务并刷新此页后重新上传。';
